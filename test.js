...
<td style="font-weight:600; color:#9ca3af">  ${statusText}

${
localStorage.getItem("currentWarehouse") === "Packing Station"
&& order.status === "pending"

?   <button id="rec" onclick="receiveInPacking('${order.orderNo}')"   style="   margin-left:8px;   background:#22c55e;   border:none;   padding:4px 8px;   border-radius:6px;   cursor:pointer;   font-size:11px;   font-weight:600;   ">   Received   </button>  
: ""
}
...
<h3>Select Warehouse for Packing</h3>  <div style="display:flex;gap:10px;flex-wrap:wrap">  ${order.warehouses.map(w=>{

return   <button onclick="markWarehousePacking('${order.orderNo}','${w.base}')"   style="   padding:10px 16px;   background:#22c55e;   border:none;   border-radius:8px;   cursor:pointer;   font-weight:600;   ">   ${w.base.toUpperCase()}   </button>  ;
